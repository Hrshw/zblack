...
const shareReferralLinkButtons = document.querySelectorAll('.shareReferralLinkButton');
const socialMediaIconsContainers = document.querySelectorAll('.socialMediaIconsContainer');
const socialMediaIcons = document.querySelectorAll('.socialMediaIcon');
const referralCode = "{{user.referralCode}}"; // Assuming user.referralCode contains the referral code

const handleShareButtonClick = (socialMediaIconsContainer) => {
  socialMediaIconsContainer.style.display = 'block';
};

shareReferralLinkButtons.forEach((button, index) => {
  button.addEventListener('click', () => {
    handleShareButtonClick(socialMediaIconsContainers[index]);
  });
});
...
socialMediaIcons.forEach(icon => {
  icon.addEventListener('click', () => {
    ...
    switch (platform) {
      case 'Facebook':
        shareLink = `https://www.facebook.com/sharer.php?u=${encodeURIComponent(`https://zblack.in/signUp?referral=${referralCode}`)}`;
        break;
      case 'Twitter':
        shareLink = `https://twitter.com/intent/tweet?url=${encodeURIComponent(`https://zblack.in/signUp?referral=${referralCode}`)}`;
        break;
     case 'WhatsApp':
            shareLink = `https://api.whatsapp.com/send?text=${encodeURIComponent(`Join me on ZBlack and earn rewards! Sign up using my referral link: https://zblack.in/signUp?referral=${referralCode}`)}`;
            break;
    ...
    window.open(shareLink);
        ...
        // const shareReferralLinkButtons = document.querySelectorAll('.shareReferralLink');
        // const socialMediaIconsContainer = document.getElementById('socialMediaIcons');
        // const socialMediaIcons = socialMediaIconsContainer.querySelectorAll('.socialMediaIcon');
        // const referralCode = "{{user.referralCode}}"; // Assuming user.referralCode contains the referral code
        
        // shareReferralLinkButtons.forEach(button => {
        //   button.addEventListener('click', () => {
        //     socialMediaIconsContainer.style.display = 'block';
        //   });
        // });
